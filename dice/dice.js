...
const DICE = (function() {
    ...
    function create_custom_d6_materials() {
        ...
        baseOpts.color = vars.dice_color;
        var baseMat = new THREE.MeshPhongMaterial(baseOpts);
        for (var i = 0; i < 22; ++i) {
        ...
        materials[2] = texMat(textures['1_2']);
        materials[3] = texMat(textures['1_2']);
        materials[4] = texMat(textures['3_4']);
        materials[5] = texMat(textures['3_4']);
        materials[6] = texMat(textures['5']);
        materials[7] = texMat(textures['6']);
        return materials;
    }
    ...
    function create_custom_d10_materials() {
        ...
        materials[1] = texMat(textures['10']);
        materials[2] = texMat(textures['1_2']);
        materials[3] = texMat(textures['1_2']);
        materials[4] = texMat(textures['3_4']);
        materials[5] = texMat(textures['3_4']);
        materials[6] = texMat(textures['5']);
        materials[7] = texMat(textures['6']);
        materials[8] = texMat(textures['7']);
        materials[9] = texMat(textures['8']);
        materials[10] = texMat(textures['9']);
        return materials;
    }

    threeD_dice.create_d6 = function() {
        if (!this.d6_geometry) this.d6_geometry = create_d6_geometry(vars.scale * 1.1);
        if (!this.d6_material) this.d6_material = new THREE.MeshFaceMaterial(create_custom_d6_materials());
    ...
    function create_custom_d12_materials() {
        ...
        materials[9] = texMat(textures['8']);
        materials[10] = texMat(textures['9']);
        materials[11] = texMat(textures['10']);
        materials[12] = texMat(textures['11']);
        materials[13] = texMat(textures['12']);
        return materials;
    }
