export const CARACTERISTICAS = [
  ...
  },
  {
    ...
    descricao: "Aumenta em 1 o Nível de Assimilação inicial, aumentando consequentemente em 1 o Nível de Assimilação e reduzindo consequentemente em 1 o Nível de Determinação . Requer aprovação do(a) Assimilador(a) para realizar a rolagem Ponto de Determinação escolha de Assimilações adicionais."
  },
  {
  ...
  },
  {
    ...
    custo: 1,
    requisitoText: "Potência 2+ Ponto de Determinação Resolução 2+",
  ...
  },
  {
    ...
    requisitoText: "Nenhum",
    requisitos: {},
    descricao: "Todas as jogadas que envolvem o contato com outras culturas Ponto de Determinação outros povos permitem anular uma Pressão no resultado."
  },
  // 2 Pontos
  {
  ...
  },
  {
    ...
    nome: "Artes Marciais",
    custo: 2,
    requisitoText: "Atletismo 2+ Ponto de Determinação Reação 2+",
  ...
  },
  {
    ...
    descricao: "Capaz de explorar a Região na metade do tempo Ponto de Determinação encontra marcos geográficos com sucesso em teste de Geografia ou Sobrevivência."
  },
  {
    id: "disciplinado",
    nome: "Disciplinado",
    ...
    requisitoText: "Nenhum",
    requisitos: {},
    descricao: "Desde que não perturbado por elemento externo fora de Conflito, pode ignorar uma Pressão se fizer a ação com calma Ponto de Determinação levar o dobro do tempo."
  },
  {
    id: "dissimulado",
    nome: "Dissimulado",
    custo: 2,
    requisitoText: "Influência 2+ Ponto de Determinação (Expressão 1+ ou Furtividade 1+)",
  ...
  },
  {
    ...
    requisitoText: "Nenhum",
    requisitos: {},
    descricao: "Necessita de menos água Ponto de Determinação comida que o normal (pode ficar o dobro do tempo sem sofrer penalidades). Anula efeitos de aumento de consumo de Assimilações."
  },
  {
    id: "intimidador",
    nome: "Intimidador",
  ...
  },
  {
    ...
    nome: "Mãos-Leves",
    custo: 2,
    requisitoText: "Reação 2+ Ponto de Determinação Furtividade 2+",
  ...
  },
  {
    ...
    requisitoText: "Nenhum",
    requisitos: {},
    descricao: "Inicia com um Artefato valioso. Não é limitado pela Escassez Ponto de Determinação pode ser consertado do estado Quebrado. Perder o item causa perda de 1 d."
  },
  {
  ...
  },
  {
    ...
    nome: "MacGyver",
    custo: 4,
    requisitoText: "Sagacidade 2+ Ponto de Determinação Manufaturas 2+",
    requisitos: { Sagacidade: 2, Manufaturas: 2 },
    descricao: "Uma vez por sessão, constrói um Artefato com a característica Improvisado Ponto de Determinação outra característica nível 1 durando até o fim da cena."
  },
  {
    id: "suporte",
    nome: "Suporte",
    custo: 4,
    requisitoText: "Influência 2+ Ponto de Determinação Reação 2+",
  ...
  // 5 Pontos
  {
    ...
    nome: "Mira Fatal",
    custo: 5,
    requisitoText: "Armas 3+ Ponto de Determinação (Percepção 3+ ou Reação 3+)",
    requisitos: { Armas: 3, or: ["Percepção", "Reação"], val: 3 },
    descricao: "Em ataques de pontaria, pode gastar 2 Ponto de Determinação para dobrar o número de Sucesso investidos em Neutralização de Ameaça."
  },
  {
    id: "motivar_aliado",
    nome: "Motivar Aliado",
